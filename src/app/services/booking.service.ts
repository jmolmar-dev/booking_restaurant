...
export class BookingService {
  /*Inicializamos la lista en el servicio*/
  private bookingList : Booking[] = [
    ...
    new Booking( 4, "María Fernández", "+34 600 345 678", "maria.fernandez@example.com", 3, "Traerá un pastel de cumpleaños.", new Date("2024-12-22 T18:30:00"), new Date("2024-12-02T09:15:00"),BookingStatus.PENDING ),
  ...
  deleteBooking (id : number){
    const booking = this.bookingList.find(booking => booking.id == id);
    if (booking){
  ...
  modifyBooking(bookingEvent: BookingEvent): void {
    switch (bookingEvent.action) {
      case "deleteBooking": this.deleteBooking(bookingEvent.bookingId); break;
